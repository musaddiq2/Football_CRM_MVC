...
{
    public class TrainingList : Controller
    {
        private readonly ApplicationDbContext _context;
        public TrainingList(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        //        .Include(t => t.InvitedFacilities) // Include related data
        //        .Select(t => new TournamentsListView
        //        {
        //            TournamentId = t.TournamentID,
        //            TournamentName = t.TournamentName,
        //            Branch = "branch", // Replace with your actual branch property
        //            StartDate = t.StartDate,
        //            EndDate = t.EndDate,
        //            Status = t.Status,
        //            InvitedFacilitiesCount = t.InvitedFacilities.Count()
        //        })
        //        .OrderByDescending(t => t.StartDate) // Order by most recent first
        //        .ToListAsync();
