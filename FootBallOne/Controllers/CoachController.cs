...
namespace FootBallOne.Controllers
{
    public class CoachController : BaseController
    {
        ...
        public CoachController(ApplicationDbContext context, IWebHostEnvironment hostEnvironment, IAcademyContext academyContext)
        : base(academyContext)
        {
            _context = context;
        ...
        {
            var coaches = FilterByAcademy(_context.Coaches.AsQueryable());
