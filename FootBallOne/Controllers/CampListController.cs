...
{
    public class CampListController : BaseController
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<CampListController> _logger;

        public CampListController(ApplicationDbContext context, ILogger<CampListController> logger, IAcademyContext academyContext)
        : base(academyContext)
        {
            _context = context;
            _logger = logger;
        ...
        {
            var camps = await FilterByAcademy(_context.Camps)
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            if (!IsSuperAdmin && camp.AcademyID != CurrentAcademyId)
            {
                TempData["ErrorMessage"] = "You don't have permission to view this camp.";
