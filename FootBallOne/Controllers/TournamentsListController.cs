...
{
    public class TournamentsListController : BaseController
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<TournamentsListController> _logger;

        public TournamentsListController(ApplicationDbContext context, ILogger<TournamentsListController> logger, IAcademyContext academyContext)
        : base(academyContext)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> Index(string searchTerm = "", string tournament = "", string status = "", string tab = "tournaments")
        {
            ...
            var matchesQuery = FilterByAcademy(_context.MatchInfo.Where(m => m.IsActive));
        ...
        {
            var tournaments = await FilterByAcademy(_context.Tournaments)
        ...
        {
            var teamsQuery = FilterByAcademy(_context.Teams.AsQueryable());
