...
namespace FootBallOne.Models
{
    public class InvitationLink
    {
        ...
        // Updated FullUrl to match your actual registration URL pattern
        [NotMapped]
        public string FullUrl => $"/RegistrationManagements/RequestRegistration?token={Token}";

        // Helper method to get absolute URL (requires base URL)
        // Methods don't need [NotMapped] attribute
